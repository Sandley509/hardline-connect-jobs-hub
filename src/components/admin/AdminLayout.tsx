...
const AdminLayout = ({ children }: AdminLayoutProps) => {
  ...
  // Define menu items based on user role - restored full admin functionality
  const getMenuItems = () => {
    const baseItems = [
      { path: '/admin/dashboard', icon: BarChart3, label: 'Dashboard' },
    ];

    // Items available to admins (full access)
    const adminItems = [
      ...
      { path: '/admin/moderators', icon: UserPlus, label: 'Role Management' },
